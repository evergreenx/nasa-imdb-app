      ...
      <div class="movie__details__top">
        ...
        <div className="">
          ...
          <div className="flex items-center  lg:text-2xl text-xl py-3">
            ...
            <div className="movie__details__genres flex space-x-4">
              {genres.map((genre) => (
                <h1 className="movie__details__genre space-x-6 ml-4 ">
                  {genre.name}
                </h1>
              ))}
            </div>
          ...
          <div class="movie__details__popularity">
          ...
          <div class="movie__details__release__date py-3">
            <h1 className="text-white font-bold ">
              Release Date:
