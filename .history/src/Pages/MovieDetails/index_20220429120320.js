          ...
          <div className="flex items-center  lg:text-2xl text-xl py-3">
            ...
            <div className="movie__details__genres flex space-x-4 lg:text-2xl text-xl font-bold ">
              {production_countries.map((country) => (
                <h1 key={country.name} className="movie__details__genre text-[#ffb703] space-x-6 ml-4  ">
                  {country.name}
                </h1>
              ))}
            </div>
          ...
          <div className="flex items-center  lg:text-2xl text-xl py-3">
            ...
            <div className="movie__details__genres flex space-x-4 lg:text-2xl text-xl font-bold ">
              {spoken_languages.map((language) => (
                <h1 key={language.name} className="movie__details__genre text-[#ffb703] space-x-6 ml-4  ">
                  {language.name}
                </h1>
              ))}
            </div>
