...
const Index = () => {
  ...
  const { poster_path, title, overview, popularity, release_date } = movieInfo;
  ...
  return (
    <section className="movie__details__container">
      <div class="movie__details__top flex items-center">
        <div class="movie__details__image">
          <img className="w-full" src={poster} alt="NASA today" />
        </div>

        <h2 className="movie__details__title">
