    ...
    <section className="movie__details__container">
      <div class="movie__details__top">
        ...
        <div className="movie__details__title">
          ...
          <div className="">
            <h1 className="text-white movie__details__genre__contain">Genres:</h1>
            {genres.map((genre) => (
              <h1 className="movie__details__genre ">{genre.name}</h1>
            ))}

            <h1 className="text-white movie__details__genre">Popularity:</h1>
            {popularity}
          </div>
        </div>
      </div>

      <div class="movie__details__desc">
        <h1>
